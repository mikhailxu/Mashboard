 	/*
   Copyright (c) 2011, iUI Project Members
...
// To do that we'll need to use the beforeInsert event
	var nodes = document.querySelectorAll(".goFullScreen");
...
function onFocus(e)
{
	if (e.target)
	{
		...
		iui.addClass(document.body, 'fullscreen');
	}
}
...
function onBlur(e)
{
	if (e.target)
	{
		...
		iui.removeClass(document.body, 'fullscreen');
	}
}
